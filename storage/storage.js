...
const ALLIANCE_DIR = path.join(STATUS_DIR, 'alliance');
const KILLS_DIR = path.join(STATUS_DIR, 'kills');
...
const initStorage = () => {
    const dirs = [CACHE_DIR, CORP_DIR, STATUS_DIR, MARKET_DIR, ALLIANCE_DIR, KILLS_DIR];
    dirs.forEach(dir => {
